...
export class CategoryPage extends BasePage {
                ...
                <div class="filters__section">
                  ...
                  <div class="filters__price">
                    <div class="price-inputs">
                      <input type="number" id="min-price" min="10" max="2000" value="10" placeholder="Min">
                      <span>-</span>
                      <input type="number" id="max-price" min="10" max="2000" value="2000" placeholder="Max">
                    </div>
                    <div class="price-range">
                      <input type="range" id="price-range" min="10" max="2000" value="2000">
                    </div>
                  </div>
                </div>
  ...
  private setupEventListeners(): void {
    ...
    if (minPriceInput && maxPriceInput && priceRange) {
      minPriceInput.addEventListener('input', () => {
        this.minPrice = parseInt(minPriceInput.value) || 10;
  ...
  private resetFilters(): void {
    ...
    if (minPriceInput) minPriceInput.value = '10';
